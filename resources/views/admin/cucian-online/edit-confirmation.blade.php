...
<section class="content-main">
	<div class="content-header">
		 <div>
			  <h2 class="content-title card-title">Konfirmasi Update Cucian Online</h2>
		 </div>
	</div>
	<div class="card">
...
<form data-confirm="Cucian Online" onsubmit="submitUpdateForm(this, event)" id="konfirmasiForm" action="{{ route('admin.cucian-online.update') }}" method="POST" style="display: none;">
	@csrf

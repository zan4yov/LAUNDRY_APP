...
<section class="content-main">
	<div class="content-header">
		 <div>
			  <h2 class="content-title card-title">Konfirmasi Proses Order Cucian Online</h2>
		 </div>
	</div>
	<div class="card">
...
<form data-confirm="Proses Order Cucian Online" onsubmit="submitUpdateForm(this, event)" id="konfirmasiForm" action="{{ route('admin.cucian-online.proses-order.update') }}" method="POST" style="display: none;">
	@csrf
	...
	<input type="hidden" name="ongkir_jemput" value="{{ $request['ongkir_jemput'] }}">
	...
	<button type="submit" id="buttonHidden">Update</button>
</form>

...
<section class="content-main">
	<div class="content-header">
		 <div>
			  <h2 class="content-title card-title">Konfirmasi Order Cucian Offline</h2>
		 </div>
	</div>
	<div class="card">
...
<form data-confirm="Cucian Offline" onsubmit="submitAddForm(this, event)" id="konfirmasiForm" action="{{ route('admin.cucian-offline.store') }}" method="POST" style="display: none;">
	@csrf
	...
	<button id="buttonHidden" type="submit" hidden></button>
</form>
